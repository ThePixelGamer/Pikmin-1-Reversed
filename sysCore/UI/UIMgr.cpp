...
LRESULT __stdcall selectWndProc(HWND hWnd, UINT Msg, WPARAM wParam,
                                LPARAM lParam) {
  UINT msg = Msg;
  if (Msg == 1) {
...
void UIMgr::RegisterGenWindowClass(LPCSTR lpszClass, void *wndProcAddr,
                                   bool a3) {
  tagWNDCLASSEXA wcx;
