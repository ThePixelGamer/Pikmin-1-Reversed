...
struct NodeVtbl
{
    ...
    (#218 * This, const IID* const riid, LPWSTR* rgszNames, UINT cNames, LCID lcid, DISPID* rgDispId);
    HRESULT(__stdcall* Invoke)
    (#218 * This, DISPID dispIdMember, const IID* const riid, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams,
...
struct ITypeInfoVtbl
{
    ...
    HRESULT(__stdcall* Invoke)
    (ITypeInfo* This, PVOID pvInstance, MEMBERID memid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult,
     EXCEPINFO* pExcepInfo, UINT* puArgErr);
    HRESULT(__stdcall* GetDocumentation)
    (ITypeInfo* This, MEMBERID memid, BSTR* pBstrName, BSTR* pBstrDocString, DWORD* pdwHelpContext,
     BSTR* pBstrHelpFile);
...
struct IDispatchVtbl
{
    ...
    HRESULT(__stdcall* GetIDsOfNames)
    (IDispatch* This, const IID* const riid, LPOLESTR* rgszNames, UINT cNames, LCID lcid, DISPID* rgDispId);
    HRESULT(__stdcall* Invoke)
    (IDispatch* This, DISPID dispIdMember, const IID* const riid, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams,
     VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr);
};
#pragma pack(pop)
...
struct ITypeCompVtbl
{
    ...
    (ITypeComp* This, LPOLESTR szName, ULONG lHashVal, WORD wFlags, ITypeInfo** ppTInfo, DESCKIND* pDescKind,
     BINDPTR* pBindPtr);
