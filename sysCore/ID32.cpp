...
void ID32::ageChangeID() { this->updateID(); }

void ID32::genAge(AgeServer &server, char *name) {
  server.setOnChange(
      new Callback<ID32 *, void (ID32::*)()>(this, &ID32::ageChangeID));
...
void ID32::operator=(unsigned __int32 _id) { this->setID(_id); }

bool ID32::operator!=(unsigned __int32 _id) { return (this->id != _id); }
