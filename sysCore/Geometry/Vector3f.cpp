...
float Vector3f::length() { // asm matches
  return doFabs((this->mX * this->mX) + (this->mY * this->mY) +
                (this->mZ * this->mZ));
}
...
void Vector3f::multMatrix(Matrix4f &a2) { // asm matches
  Vector3f tmp;
  tmp.mX = a2.mMatrix4f[0][0] * this->mX + a2.mMatrix4f[0][1] * this->mY +
           a2.mMatrix4f[0][2] * this->mZ + a2.mMatrix4f[0][3];
  tmp.mY = a2.mMatrix4f[1][0] * this->mX + a2.mMatrix4f[1][1] * this->mY +
           a2.mMatrix4f[1][2] * this->mZ + a2.mMatrix4f[1][3];
  tmp.mZ = a2.mMatrix4f[2][0] * this->mX + a2.mMatrix4f[2][1] * this->mY +
           a2.mMatrix4f[2][2] * this->mZ + a2.mMatrix4f[2][3];
  *this = tmp;
}

void Vector3f::multMatrixTo(Matrix4f &a2, Vector3f &a3) { // asm matches
  a3.mX = a2.mMatrix4f[0][0] * this->mX + a2.mMatrix4f[0][1] * this->mY +
          a2.mMatrix4f[0][2] * this->mZ + a2.mMatrix4f[0][3];
  a3.mY = a2.mMatrix4f[1][0] * this->mX + a2.mMatrix4f[1][1] * this->mY +
          a2.mMatrix4f[1][2] * this->mZ + a2.mMatrix4f[1][3];
  a3.mZ = a2.mMatrix4f[2][0] * this->mX + a2.mMatrix4f[2][1] * this->mY +
          a2.mMatrix4f[2][2] * this->mZ + a2.mMatrix4f[2][3];
}
...
void Vector3f::rotate(Matrix4f &a2) { // asm matches
  Vector3f tmp;
  tmp.mX = a2.mMatrix4f[0][0] * this->mX + a2.mMatrix4f[0][1] * this->mY +
           a2.mMatrix4f[0][2] * this->mZ;
  tmp.mY = a2.mMatrix4f[1][0] * this->mX + a2.mMatrix4f[1][1] * this->mY +
           a2.mMatrix4f[1][2] * this->mZ;
  tmp.mZ = a2.mMatrix4f[2][0] * this->mX + a2.mMatrix4f[2][1] * this->mY +
           a2.mMatrix4f[2][2] * this->mZ;
  *this = tmp;
}
...
void Vector3f::rotate(Quat &a2) { // asm matches
  ...
  this->mX =
      tmp.mX * a2.mW + -a2.mZ * tmp.mY - -a2.mY * tmp.mZ + -a2.mX * tmp.mW;
  this->mY =
      -tmp.mX * -a2.mZ + tmp.mY * a2.mW + -a2.mX * tmp.mZ + -a2.mY * tmp.mW;
  this->mZ =
      -a2.mY * tmp.mX - -a2.mX * tmp.mY + tmp.mZ * a2.mW + -a2.mZ * tmp.mW;
}
...
void Vector3f::rotateTranspose(Matrix4f &a2) { // asm matches
  Vector3f tmp;
  tmp.mX = a2.mMatrix4f[0][0] * this->mX + a2.mMatrix4f[1][0] * this->mY +
           a2.mMatrix4f[2][0] * this->mZ;
  tmp.mY = a2.mMatrix4f[0][1] * this->mX + a2.mMatrix4f[1][1] * this->mY +
           a2.mMatrix4f[2][1] * this->mZ;
  tmp.mZ = a2.mMatrix4f[0][2] * this->mX + a2.mMatrix4f[1][2] * this->mY +
           a2.mMatrix4f[2][2] * this->mZ;
  *this = tmp;
}
...
void Vector3f::set(const float &a2, const float &a3,
                   const float &a4) { // asm matches
  this->mX = a2;
  this->mY = a3;
  this->mZ = a4;
}
...
void Quat::fromMat3f(Matrix3f &mtx) { // asm matches :')
  float tmp1 =
      (mtx.mMatrix3f[0][0] + mtx.mMatrix3f[1][1] + mtx.mMatrix3f[2][2] + 1.0f) *
      0.25f;
  ...
  tmp7 = 1.0f / doSqrt(this->mW * this->mW + this->mX * this->mX +
                       this->mY * this->mY + this->mZ * this->mZ);
  this->mW *= tmp7;
  this->mX *= tmp7;
  this->mY *= tmp7;
  this->mZ *= tmp7;
...
void Quat::genVectorX(Vector3f &vec) { // asm matches
...
void Quat::genVectorY(Vector3f &vec) { // asm matches
...
void Quat::genVectorZ(Vector3f &vec) { // asm matches
...
void Quat::multiply(Quat &a2) { // asm matches
  Quat quat;
  quat.mW =
      a2.mW * this->mW - a2.mX * this->mX - a2.mY * this->mY - a2.mZ * this->mZ;
  quat.mX =
      a2.mW * this->mX + a2.mX * this->mW + a2.mY * this->mZ - a2.mZ * this->mY;
  quat.mY =
      a2.mW * this->mY + a2.mY * this->mW + a2.mZ * this->mX - a2.mX * this->mZ;
  quat.mZ =
      a2.mW * this->mZ + a2.mZ * this->mW + a2.mX * this->mY - a2.mY * this->mX;
  *this = quat;
}

void Quat::multiplyTo(Quat &a2, Quat &a3) { // asm matches
...
void Quat::normalise() { // asm matches
  float v2 = 1.0f / doSqrt(this->mX * this->mX + this->mY * this->mY +
...
void Quat::rotate(Vector3f &a2, float a3) { // asm matches
...
float doACos(float a2) { // asm matches
  return acos(a2);
}

void Quat::slerp(Quat &a2, float a3, int a4) { // asm matches
  float v5, v4, v3;
  float v2 =
      this->mX * a2.mX + this->mY * a2.mY + this->mZ * a2.mZ + this->mW * a2.mW;
  float v1;
  int b1;
