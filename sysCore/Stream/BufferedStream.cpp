...
BufferedInputStream::BufferedInputStream(Stream *stream, unsigned __int8 *buf,
                                         int bufSize) {
...
int BufferedInputStream::getPending() {
  return this->m_bufferStream->getPending() - this->m_position;
}
...
void BufferedInputStream::init(Stream *stream, unsigned __int8 *buf,
                               int bufSize) {
...
BufferedOutputStream::BufferedOutputStream(Stream *stream, int bufferSize,
                                           bool unk) {
  this->m_bufferStream = stream;
