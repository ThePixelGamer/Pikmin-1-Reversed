...
String::String() { this->init(64); }

String::String(int stringLength) { this->init(stringLength); }

String::String(char* string, int stringLength) { this->init(string, stringLength); }
...
void String::init(char* _string) { this->m_string = _string; }
...
bool String::contains(char* arg) { return this->contains(this->m_string, arg); }
...
bool String::isSame(String* toCompare) { return this->isSame(toCompare->m_string); }
...
bool String::equals(char* str1, char* str2) { return String::isSame(str1, str2); }

char* String::dup() { return String::dup(this->m_string); }
...
{
    return toCheck == ' ' || toCheck == '\t' || toCheck == '\r' || toCheck == '\n' || toCheck < ' ';
}
