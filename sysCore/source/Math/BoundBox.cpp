...
{
    return check.m_minBounds.mX <= this->m_maxBounds.mX && check.m_maxBounds.mX >= this->m_minBounds.mX &&
           check.m_minBounds.mY <= this->m_maxBounds.mY && check.m_maxBounds.mY >= this->m_minBounds.mY &&
           check.m_minBounds.mZ <= this->m_maxBounds.mZ && check.m_maxBounds.mZ >= this->m_minBounds.mZ;
}
