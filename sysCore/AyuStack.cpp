...
void haltAyuStack(char *fmt, ...) {
  ...
  System::halt("c:\\development\\dolphinpiki\\syscommon\\ayustack.cpp", 7,
               &Dest);
}
...
bool AyuStack::checkOverflow() {
  return (this->active) ? *this->top != 0x12345678 : false;
}
...
void AyuStack::create(char *nme, int allocType, void *allocMem, int size,
                      bool overflow) {
