...
int sub_401130()
{
  return System::System(&unk_416648);
}
...
int sub_401180()
{
  return atexit(sub_4011D0);
}

//----- (004011D0) --------------------------------------------------------
void __cdecl sub_4011D0()
{
  System::~System(&unk_416648);
}
...
// 417468: using guessed type void *__thiscall ModuleMgr::Alloc(ModuleMgr *__hidden this, char *);
...
char *__cdecl sub_401910(char *Format, char a2)
{
  ...
  if ( sysCon )
  {
    ...
    {
      v3 = strlen(&Dest);
      result = (char *)(*(int (__thiscall **)(struct Stream *, char *, size_t))(*(_DWORD *)sysCon + 56))(
                         sysCon,
                         &Dest,
                         v3);
    }
...
char *sub_401A30()
{
  ...
  (*(void (__thiscall **)(int, const char *, char *, HMENU))(*(_DWORD *)dword_416AB8 + 80))(
    dword_416AB8,
    "DUIClearWin",
    off_416520,
    v1);
...
// 417438: using guessed type _DWORD __thiscall RectArea::RectArea(RectArea *__hidden this, _DWORD, _DWORD, _DWORD, _DWORD);
// 41743C: using guessed type void __thiscall UIFrame::setFrame(UIFrame *__hidden this, struct RectArea *);
...
// 417418: using guessed type _DWORD __thiscall UIWindow::UIWindow(UIWindow *__hidden this, struct UIWindow *, _DWORD, _DWORD, _DWORD, bool);
...
// 41741C: using guessed type _DWORD __thiscall UIWindow::processMessage(UIWindow *__hidden this, HWND, unsigned int, unsigned int, _DWORD);
// 417468: using guessed type void *__thiscall ModuleMgr::Alloc(ModuleMgr *__hidden this, char *);
// 41747C: using guessed type struct ModuleMgr *modMgr;
